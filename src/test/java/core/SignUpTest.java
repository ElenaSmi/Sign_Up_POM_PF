...
public class SignUpTest {
	...
	public void    test_11_verify_content_quotes() {
		String firstQuote = sp.verifyContent(SignUpPage.quotes, baseUrl);
		driver.navigate().refresh();
		String secondQuote = sp.verifyContent(SignUpPage.quotes1, baseUrl);
	...
	public void    test_12_verify_content_current_city() throws IOException {
		...
		String cityStateActual = sp.verifyContent( SignUpPage.location, baseUrl);
	...
	public void    test_13_verify_content_current_weather() throws IOException {
		...
		String actualTemp = sp.verifyContent(SignUpPage.temperature, baseUrl);
	...
	public void   test_14_verify_content_date() {
		...
		String actualDate = sp.verifyContent(SignUpPage.time, baseUrl);
	...
	public void   test_15_verify_content_os() {
		...
		String actualOs = sp.verifyContent(SignUpPage.os_browser, baseUrl);
	...
	public void    test_16_verify_content_browser() {
		...
		String osBrActual = sp.verifyContent(SignUpPage.os_browser, baseUrl);
